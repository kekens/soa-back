...
import com.kekens.model.Difficulty;
...
public class LabWorkFilterUtil {
    ...
    public LabWorkFilterUtil(LabWorkFilterConfiguration labWorkFilterConfiguration) {
        this.nameStrArray = labWorkFilterConfiguration.getNameStrArray();
        this.coordinatesXStrArray = labWorkFilterConfiguration.getCoordinatesXStrArray();
        this.coordinatesYStrArray = labWorkFilterConfiguration.getCoordinatesYStrArray();
        this.creationDateStrArray = labWorkFilterConfiguration.getCreationDateStrArray();
        this.minimalPointStrArray = labWorkFilterConfiguration.getMinimalPointStrArray();
        this.difficultyStrArray = labWorkFilterConfiguration.getDifficultyStrArray();
        this.disciplineNameStrArray = labWorkFilterConfiguration.getDisciplineNameStrArray();
        this.disciplineLectureHoursStrArray = labWorkFilterConfiguration.getDisciplineLectureHoursStrArray();
        this.sortingParams = labWorkFilterConfiguration.getSortingParams();
        this.pageSize = labWorkFilterConfiguration.getPageSize();
        this.pageIndex = labWorkFilterConfiguration.getPageIndex();
    }
